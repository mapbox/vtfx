...
function decodeLoadImage(zxy, filepath, format) {
...
var uint8query = decodeLoadImage(zxy, 'raster-tests/24989.png', 'png');
...
var Float32query = decodeLoadImage(zxy, 'raster-tests/24989_ndvi.tif');
